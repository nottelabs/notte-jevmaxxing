...
// The session starts with the task. Its live viewer is embedded as soon as it exists, while the agent connects.
...
$("clear").addEventListener("click", () => {
  ...
  post("close").catch(() => {}); // the finished task's session is no longer on screen
});
